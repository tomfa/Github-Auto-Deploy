...
** (optional) specify ref variable if you want to only pull when GitHub receives push on certain branch
** (optional) specify secret if you want to check signature against payload from Github
...
"Post-Receive URLs" and add the url of your machine + port (e.g. http://example.com:8001). Use x-www-form-urlencoded content type.
